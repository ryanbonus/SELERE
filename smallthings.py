...
def update_tank(value):
    ...
    tank_height = int(value)  # Directly use the value as the tank height
...
slider = tk.Scale(frame, from_=0, to=100, orient="vertical", command=update_tank, sliderlength=30)
